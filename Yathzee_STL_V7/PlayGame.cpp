...
void playGame(map<int, int>& d, set<Players>& p, list<Scorecard>& s, int a[]) {
    // Game variables
    int round = 0;
    int place = 0;
    int ply = 0;
...
void getScores(list<Scorecard>& s, int a[], list<Scorecard>::iterator i, set<Players>::iterator j) {
    //dispay scorecard
    card(s, i, j);
